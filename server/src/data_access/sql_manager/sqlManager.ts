...
export class SqlParameter {
    constructor(_name: string, _type: any, _value: any) {
        this.name = _name;
        this.value = _value;
        this.type = _type;
    }
...
export class SqlManager {
    ...
    public async executeQuery(query: string, params?: Array<SqlParameter>) {
        try {
            await this.connect();
    ...
    public async executeNonQuery(query: string, params?: Array<SqlParameter>) {
        try {
            await this.connect();
            const ps = new sql.PreparedStatement(this.pool);
            const paramObj: any = {};
